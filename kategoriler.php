...
INNER JOIN kategoriler ON kategoriler.id = yazilar.yaz_kat_id
                 WHERE yazi_durum=:d      AND yaz_kat_id=:kat");
...
INNER JOIN kategoriler ON kategoriler.id = yazilar.yaz_kat_id
                 WHERE yazi_durum=:d AND yaz_kat_id=:kat  ORDER BY yazi_tarih DESC LIMIT :goster,:lim
                                ");
                    ...
                    ?>
                        ...
                        echo'<div class="alert alert-danger">Bu Kategoriye Henüz Konu Eklenmedi</div>';
                    }
                    ?>
