...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-comment"></i> Bekleyen Yorumlar</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
              ...
              $sorgu=$db->prepare("SELECT * FROM yorumlar INNER JOIN yazilar ON yazilar.yazi_id=yorumlar.yorum_yazi_id
 WHERE yorum_durum=:d  ORDER BY id DESC LIMIT :goster,:lim");
              ...
              ?>
            <h3 class="tile-title">BEKLEYEN YORUMLAR (<?php echo $toplam; ?>)</h3>
            <div class="table-responsive table-hover">
             ...
             <?php }?>
              ...
              <?php }else{
                  echo "<div class='alert alert-danger'>Bekleyen Yorum Bulunmuyor</div>";
              }
              ?>
