...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-comment"></i> Onaylı Yorumlar</h1>
          <p>Onaylı Yorumlar</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Onaylı Yorumlar</a></li>
        </ul>
      </div>
      <div class="row">
 ...
 WHERE yorum_durum=:d  ORDER BY id DESC LIMIT :goster,:lim");
              ...
              ?>
            <h3 class="tile-title">ONAYLI YORUMLAR (<?php echo $toplam; ?>)</h3>
