...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-users"></i>Üye</h1>
          <p>Üye Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Üyeler</li>
          <li class="breadcrumb-item active"><a href="#">Üye Listesi</a></li>
        </ul>
      </div>
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="tile">
              ...
              ?>
            <h3 class="tile-title">Üye Listesi (<?php echo $toplam; ?>)</h3>
            <div class="table-responsive table-hover">
             ...
             <?php foreach ($sorgu as $row){?>
                      <tr>
                          ...
                          <td><a href="<?php echo $yonetim."/islemler.php?islem=abone&id=".$row['id']; ?>"><i class="fa fa-eye"></i></a>|<a onclick="return confirm('Abone silme işlemini onaylıyor musunuz ?');" href="<?php echo $yonetim."/islemler.php?islem=editsil&id=".$row['id']; ?>"><i class="fa fa-eraser"></i></a></td>
                      </tr>
             ...
             <?php }?>
                      ...
                      <ul class="pagination">
                          <?php
                          if($toplam>$lim){
                              pagination($s,ceil($toplam/$lim), 'abone.php?s=');
                          }
                          ?>
                      </ul>
              <?php }else{
