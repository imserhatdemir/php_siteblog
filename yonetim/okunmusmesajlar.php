            ...
            <div class="table-responsive table-hover">
             ...
             <?php foreach ($sorgu as $row){?>
                      <tr>
                          ...
                          <td><a href="<?php echo $yonetim."/islemler.php?islem=mesajoku&id=".$row['id']; ?>"><i class="fa fa-eye"></i></a> | <a onclick="return confirm('silme işlemini onaylıyor musunuz ?');" href="<?php echo $yonetim."/islemler.php?islem=mesajsil&id=".$row['id']; ?>"><i class="fa fa-eraser"></i></a></td>
                      </tr>
             ...
             <?php }?>
              ...
              <?php }else{
                  echo "<div class='alert alert-danger'>Okunmuş Mesaj Bulunmuyor</div>";
              }
              ?>
