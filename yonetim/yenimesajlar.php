...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-envelope"></i> MESAJLAR </h1>
          <p>Yeni Mesajlar</p>
        </div>
            ...
            <div class="table-responsive table-hover">
             ...
             <?php foreach ($sorgu as $row){?>
                      <tr>
                          ...
                          <td><a href="<?php echo $yonetim."/islemler.php?islem=mesajoku&id=".$row['id']; ?>"><i class="fa fa-eye"></i></a> | <a onclick="return confirm('Kategori silindiği zaman bu kategoriye ait tüm konular pasif duruma gelecektir onaylıyor musunuz ?');" href="<?php echo $yonetim."/islemler.php?islem=mesajsil&id=".$row['id']; ?>"><i class="fa fa-eraser"></i></a></td>
                      </tr>
             ...
             <?php }?>
                      ...
                      <ul class="pagination">
                          <?php
                          if($toplam>$lim){
                              pagination($s,ceil($toplam/$lim), 'yenimesajlar.php?s=');
                          }
                          ?>
                      </ul>
              <?php }else{
                  echo "<div class='alert alert-danger'>Yeni Mesaj Bulunmuyor</div>";
              }
              ?>
